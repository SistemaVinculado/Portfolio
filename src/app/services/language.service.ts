...
export class LanguageService {
  ...
  private readonly officialLanguage = 'pt-BR';
  ...
  private loadLanguage(): void {
    const path = `${I18N_ASSET_PATH}${this.officialLanguage}.json`;
    ...
    this.http.get<any>(path)
      ...
      .subscribe({
        ...
        error: (err) => {
          console.error(`[StellarDev] CRITICAL ERROR: Translation file for language "${this.officialLanguage}" could not be loaded.`);
